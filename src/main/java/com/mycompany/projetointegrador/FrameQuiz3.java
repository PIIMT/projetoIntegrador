 ...
 * @author felip_000
 */
public class FrameQuiz3 extends javax.swing.JFrame {
    ...
    public FrameQuiz3() {
        ...
        try {
            ...
            Logger.getLogger(FrameQuiz3.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        perguntaLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        perguntaLabel4.setForeground(new java.awt.Color(255, 255, 255));
        perguntaLabel4.setText("Pergunta 3");

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jPanel1.setBackground(new java.awt.Color(69, 134, 198));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Questão 3", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        respostaq1RadioButton1.setText("Resposta1q3");
        ...
        respostaq1RadioButton2.setText("Resposta2q3");
        ...
        respostaq1RadioButton3.setText("Resposta3q3");
        ...
        respostaq1RadioButton4.setText("Resposta4q3");
    ...
    private void voltaButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_voltaButtonActionPerformed
        ...
        try {
            ...
            var dt = new FrameQuiz2(); //chama uma tela específica
    ...
    private void proximoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_proximoButtonActionPerformed
        ...
        try {
            ...
            if (respostaq1RadioButton1.isSelected() || respostaq1RadioButton2.isSelected() || respostaq1RadioButton3.isSelected() || respostaq1RadioButton4.isSelected()){
                ...
                var dt = new FrameQuiz4(); //chama uma tela específica o nome para sua tentativa:
                dt.setVisible(true); //faz tal tela ser visível
                dispose(); // descarta a tela atual
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameQuiz3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameQuiz3().setVisible(true);
            }
        });
    }
