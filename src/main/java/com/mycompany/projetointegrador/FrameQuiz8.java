 ...
 * @author felip_000
 */
public class FrameQuiz8 extends javax.swing.JFrame {
    ...
    public FrameQuiz8() {
        ...
        try {
            ...
            Logger.getLogger(FrameQuiz8.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Questão 8", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        respostaq1RadioButton1.setText("Resposta1q8");
        ...
        respostaq1RadioButton2.setText("Resposta2q8");
        ...
        respostaq1RadioButton3.setText("Resposta3q8");
        ...
        respostaq1RadioButton4.setText("Resposta4q8");
    ...
    private void voltaButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_voltaButtonActionPerformed
        ...
        try {
            ...
            var dt = new FrameQuiz7(); //chama uma tela específica
    ...
    private void proximoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_proximoButtonActionPerformed
        ...
        try {
            ...
            if (respostaq1RadioButton1.isSelected() || respostaq1RadioButton2.isSelected() || respostaq1RadioButton3.isSelected() || respostaq1RadioButton4.isSelected()){
                ...
                var dt = new FrameQuiz9(); //chama uma tela específica o nome para sua tentativa:
                dt.setVisible(true); //faz tal tela ser visível
                dispose(); // descarta a tela atual
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameQuiz8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameQuiz8().setVisible(true);
            }
        });
    }
